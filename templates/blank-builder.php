...
?>
<div class="wccon-builder-wrapper <?php echo esc_attr( $local_storage ? '' : 'wccon-builder-nostorage' ); ?>" data-wccon-builder="<?php echo esc_attr( $config_info['id'] ); ?>" data-wccon-scheme="<?php echo $data_attr; // WPCS: XSS ok. ?>">
